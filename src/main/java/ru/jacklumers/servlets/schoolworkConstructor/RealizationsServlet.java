...
@WebServlet("/schoolworkConstructor/realizations")
public class RealizationsServlet  extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getServletContext()
                .getRequestDispatcher("/jsp/schoolworkConstructor/realizations.jsp")
                .forward(req, resp);
    }
