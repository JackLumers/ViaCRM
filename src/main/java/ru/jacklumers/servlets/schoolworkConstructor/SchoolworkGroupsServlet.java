...
@WebServlet("/schoolworkConstructor/schoolworkGroups")
public class SchoolworkGroupsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getServletContext()
                .getRequestDispatcher("/jsp/schoolworkConstructor/schoolworkGroups.jsp")
                .forward(req, resp);
    }
