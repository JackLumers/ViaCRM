...
@WebServlet("/schoolworkConstructor/schoolworks")
public class SchoolworksServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getServletContext()
                .getRequestDispatcher("/jsp/schoolworkConstructor/schoolworks.jsp")
                .forward(req, resp);
    }
