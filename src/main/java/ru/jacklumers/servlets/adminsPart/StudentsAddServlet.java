 ...
 */
@WebServlet("/adminsPart/students/add")
public class StudentsAddServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getServletContext().getRequestDispatcher("/jsp/adminsPart/studentsAdd.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/adminsPart/students/add");
    }
