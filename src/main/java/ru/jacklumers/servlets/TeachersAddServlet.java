...
import ru.jacklumers.dao.TeachersDao;
import ru.jacklumers.dao.TeachersDaoJdbcTemplateImpl;
...
public class TeachersAddServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        RequestDispatcher dispatcher = req.getServletContext().getRequestDispatcher("/jsp/teachersAdd.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/teachers/add");
    }
